...
class ErrorDocument extends HtmlDocument
{
	 ...
	 * @since  1.0.0
	 */
	public function render(bool $caching = false, array $params = array()): string
	{
		...
		$errorReporting = $this->application->get('error_reporting');
		...
		$this->getApplication()->setHeader('status', $status);
		...
		return parent::render($caching, $params);
	}
