...
class XmlDocument extends Document
{
	 ...
	 * @since  1.0.0
	 */
	public function render(bool $cache = false, array $params = array()): string
	{
		parent::render($cache, $params);

		$disposition = $this->isDownload ? 'attachment' : 'inline';

		$this->application->setHeader('Content-disposition', $disposition . '; filename="' . $this->getName() . '.xml"', true);
